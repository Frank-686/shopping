<template>
  <div class="w3layouts-bg" style="height: 100vh">
        ...
        <div class="w3layouts-right">
            <div class="w3ls-text">
                <h3>we're sorry!</h3>
                <h4 class="w3-agileits2">找不到页面</h4>
                <router-link to="/">
                  请返回首页
                </router-link>
            </div>
...
.agileits-content {
	...
	float: left;
	width: 56%;
	background: url('/static/images/banner.png') center no-repeat;
...
.w3layouts-right {
	float: left;
	width: 44%;
	background: url('/static/images/cut.jpg') no-repeat center;
	background-size: cover;
	min-height: 690px;
}
.w3layouts-right h3 {
